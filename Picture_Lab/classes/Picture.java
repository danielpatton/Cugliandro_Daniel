...
public class Picture extends SimplePicture 
{
  ...
  public void c2py(Picture fromPic, 
                 int startRow, int endRow, int endCol, int startCol)
  {
    Pixel fromPixel = null;
    Pixel toPixel = null;
    Pixel[][] toPixels = this.getPixels2D();
  ...
  {
	Picture chicken = new Picture("chickenandwaffles.jpg");
    Picture koala = new Picture("koala.jpg");
	Picture butter = new Picture("butterfly1.jpg");
    this.copy(chicken,0,0);
    this.copy(koala,100,0);
    this.copy(butter,200,0);
	
    Picture chickenNoBlue = new Picture(chicken);
    chickenNoBlue.zeroBlue();
	
	Picture koalagrayscale = new Picture(koala);
    koalagrayscale.grayscale();
	
	Picture butterkeepOnlyBlue = new Picture(butter);
    butterkeepOnlyBlue.keepOnlyBlue();
	
    this.copy(chickenNoBlue,300,0);
    this.copy(koalagrayscale,400,0);
    this.copy(butterkeepOnlyBlue,500,0);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
